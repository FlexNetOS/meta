...
| FACT | flexnetos_runner is the root execution peer and sole canonical source for the Nix GitHub runner. | /home/flexnetos/meta/flexnetos_runner/nix/gha-runner/flake.nix |
| FACT | The canonical closure carries actions/runner 2.335.1 and uses an explicit foreground session; no runner system/user activation path exists. | /home/flexnetos/meta/flexnetos_runner/nix/gha-runner/scripts/runner-start.nu |
| FACT | envctl is the sole broker for short-lived GitHub App and runner registration tokens; the private key is not handled by the runner. | /home/flexnetos/meta/flexnetos_runner/nix/gha-runner/scripts/mint-runner-token.nu |
